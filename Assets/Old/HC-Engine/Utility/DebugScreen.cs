...
namespace editor
{
    public class DebugScreen : Editor
    {
        ...
        {
            Add(text, NotificationType.Info);
        }

        public static void LogError(string text)
        {
            Add(text, NotificationType.Error);
        }

        public static void LogWarning(string text)
        {
            Add(text, NotificationType.Warning);
        }
        ...
        private static void Add(string text, NotificationType type)
        {
        ...
        private static void OnScene(SceneView sceneView)
        {
            ...
            foreach (Notification n in notifications)
            {
                ...
                GUI.Label(lineRect, new GUIContent(" " + timeString + "" + n.text + ""));
